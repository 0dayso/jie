$(function(){
    ...
    $('#idcard').blur(function () {
        ...
        if(len ==15 || len ==18){
            $.post('http://localhost/jie/index.html/index/CheckIdcard',{"idcard":idvalue},function (data) {
                //判断返回信息，并向用户展示
    ...
    $('#email').blur(function () {
        ...
        if(flag){
            $.post('http://localhost/jie/index.html/index/CheckEmail',{"email":emailvalue}, function (data) {
                if(data == null || data== undefined || data == ''){
    ...
    $('#username').blur(function () {
        ...
        if(namevalue.length<2 || namevalue.length>12){
            ...
            $.post('http://localhost/jie/index.html/index/CheckName',{'username':namevalue},function (data) {
                if(data == null || data== undefined || data == ''){
    ...
    $('#password').blur(function () {
        ...
        if(passwordvalue.length<6){
            ...
            $.post('http://localhost/jie/index.html/index/CheckPassword',{'password':passwordvalue},function (data) {
                if(data == null || data== undefined || data == ''){
    ...
    $('#lemail').blur(function () {
        ...
        var flag = pattern.test(emailvalue);
        if(flag){
            $.post('http://localhost/jie/index.html/index/LogEmail',{"email":emailvalue}, function (data) {
                if(data == null || data== undefined || data == ''){
    ...
    $('#lpassword').blur(function () {
        ...
        if(passwordvalue.length<6){
            ...
            $.post('http://localhost/jie/index.html/index/LogPassword', {'password': passwordvalue},function (data) {
                if(data == null || data== undefined || data == ''){
